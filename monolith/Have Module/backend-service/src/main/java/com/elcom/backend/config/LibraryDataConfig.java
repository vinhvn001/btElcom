...
@EnableJpaRepositories(basePackages = "com.elcom.data.repository.library",
...
public class LibraryDataConfig {
    ...
    public LocalContainerEntityManagerFactoryBean libraryEntityManagerFactory( EntityManagerFactoryBuilder builder){
        return builder.dataSource(libraryDataSource()).packages("com.elcom.data.model.library").build();
    }
